...
namespace Sastras_Alina_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Sastras_Alina_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Sastras_Alina_Lab2Context context,
